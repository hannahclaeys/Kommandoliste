...
kommandoer = kommandoer[kommandoer["Kategori"] == "Spektralsætningen, diagonalisering og Hermitiske matricer"]
...
def layout():
    with gr.Blocks() as ui:
        gr.Markdown("## 🧮 Spektralsætningen, diagonalisering og Hermitiske matricer")
